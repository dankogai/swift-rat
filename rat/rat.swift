...
public extension RatElement {
    public init<U:RatElement>(_ x:U) {
        ...
        case let q as Int64:    self.init(q)
        case let w as Int32:    self.init(w)
        case let h as Int16:    self.init(h)
        case let b as Int8:     self.init(b)
        default:
...
extension Int64: RatElement {}
extension Int32: RatElement {}
extension Int16: RatElement {}
extension Int8:  RatElement {}
...
typealias RatInt64  = Rat<Int64>
typealias RatInt32  = Rat<Int32>
typealias RatInt16  = Rat<Int16>
typealias RatInt8   = Rat<Int8>
